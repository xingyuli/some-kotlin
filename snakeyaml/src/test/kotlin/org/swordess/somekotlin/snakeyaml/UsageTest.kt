package org.swordess.somekotlin.snakeyaml
...
"""
    ...
    fun testGetBeanAssumeClass() {
        val document = """
--- !!org.swordess.somekotlin.snakeyaml.Person
firstName: Andrey
age: 99
"""
    ...
    fun testGetConstructorBean() {
        val document = "--- !!org.swordess.somekotlin.snakeyaml.Person [ Andrey, 99 ]"
        val obj = Yaml().load(document)
        assertNotNull(obj)
        assertTrue("Unexpected: ${obj.javaClass}", obj is Person)
...
"""
    ...
    fun testDumpCustomJavaClass() {
        ...
        /*
         * Produces:
         * !!org.swordess.somekotlin.snakeyaml.Car
         * plate: NOT-FAMOUS
         * wheels:
         * - {brand: brandA, id: 1}
         * - {brand: brand2, id: 2}
